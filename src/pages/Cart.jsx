...
export default function Cart() {
  ...
  const calculateCartTotals = (cartItems) => {
    ...
    const finalTotal = subTotal - totalDiscount + 15; // Add fixed shipping cost of 15
  ...
  const { subTotal, totalDiscount, finalTotal } = calculateCartTotals(cartItems);
const handleCheckout = () => {
  ...
  return (
    <div className="container mx-auto pt-7 pb-20">
      ...
      {cartItems.length === 0 ? (
        <p className="text-2xl satoshi-font py-20">Your cart is empty. 🥺</p>
      ) : (
        <>
          <div className="py-10 flex flex-col gap-y-5 lg:gap-y-0 lg:gap-x-5 lg:flex-row m-3 lg:m-0">
            ...
            <div className="w-full lg:w-1/3 p-5 md:p-10 border-2 border-gray-300 rounded-3xl">
              ...
              <div className="flex gap-x-2 pt-5 relative">
                ...
                <button className="w-1/3 py-5 px-5 bg-black text-white rounded-full font-semibold satoshi-font cursor-pointer active:shadow-lg">
                  Apply
                </button>
              </div>
              ...
              <button
                ...
                className="mt-5 w-full py-5 px-5 bg-black text-white rounded-full font-semibold satoshi-font cursor-pointer active:shadow-lg"
              >
                Proceed To Checkout
              </button>
            </div>
